...
storiesOf("InterviewerList", module)
  ...
  .add("Empty", () => <Empty onAdd={action('Empty')} />)
  ...
  .add("Edit", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} student={'Some Student'} interviewer={2} />)
